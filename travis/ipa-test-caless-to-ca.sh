...
# Install IPA-server
echo "Installing IPA with CA mode..."
ipa-server-install -U --domain pki.test --realm PKI.TEST -p ${server_password} -a ${server_password} --setup-dns --auto-forwarders --selfsign

# Test whether IPA server is reachable
echo ${server_password} | kinit admin && ipa ping

# Install IPA-ca
echo "Installing IPA CA..."
ipa-ca-install -p ${server_password} -w ${server_password} -U
